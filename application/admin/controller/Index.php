	...
	public function login($username = '', $password = '', $verify = '') {
		if (IS_POST) {
			...
			if ($uid > 0) {
				...
				$groupid = db('auth_group_access')->where('uid='.$uid)->value('group_id');
				switch($groupid){
					case 6:return $this->success('登录成功！', url('admin/food/foodstaff'));break;
					case 8:return $this->success('登录成功！', url('admin/qlx/index'));break;
					case 13:return $this->success('登录成功！', url('admin/qlx/index'));break;
					case 14:return $this->success('登录成功！', url('admin/food/foodstaff'));break;
				}
