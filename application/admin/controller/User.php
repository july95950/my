...
class User extends Admin {
	...
	public function add() {
		...
		if (IS_POST) {
			...
			//创建注册用户
			$result = $model->register($data['username'], $data['password'], $data['repassword'], $data['email'],$data['mobile'], false);
			if ($result) {
