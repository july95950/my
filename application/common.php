...
// JunYuCMS常量定义
define('JUNYUCMS_VERSION', '5.0.20170122');
define('JUN_ADDON_PATH', ROOT_PATH . DS . 'addons' . DS);
...
function authcode($string, $operation = 'DECODE', $key = '', $expiry = 0) {
	...
	// 当此值为 0 时，则不产生随机密钥
	$uc_key = config('data_auth_key') ? config('data_auth_key') : 'junyucms';
