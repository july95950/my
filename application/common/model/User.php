...
class User extends Base{
	...
	public $addfield = array(
		...
		array('name'=>'password','title'=>'密码','type'=>'password','help'=>'用户初始密码为<font style="color:#f60">123456</font>,用户密码不能少于6位'),
		array('name'=>'repassword','title'=>'确认密码','type'=>'password','help'=>'确认密码'),
		array('name'=>'email','title'=>'邮箱','type'=>'text','help'=>'用户邮箱，用于找回密码等安全操作'),
		array('name'=>'mobile','title'=>'手机','type'=>'text','help'=>'用户手机号码'),
	);
	...
	*/
	 ...
	 */
	function register($username, $password, $repassword, $email,$mobile, $isautologin = true){
